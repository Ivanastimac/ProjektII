# -*- coding: utf-8 -*-
"""
Created on Mon Dec 12 16:19:50 2022
...
work_dir = 'C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCCancer\\Logger\\'

from niapy.task import Task
from niapy.problems import Problem
from my_niapy.algorithms.basic.abc import ArtificialBeeColonyAlgorithm
...
log_file = open(str(work_dir + 'logger_cancer_ABC ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
print('ABC Algorithm')
print()
...
for i, (train_index, test_index) in enumerate(skf.split(x, y)):
    ...
    plt.savefig('C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCCancer\\Matrix\\default\\ABCCancer' + str(i) +'.png')
    plt.show()
