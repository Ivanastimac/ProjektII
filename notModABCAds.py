# -*- coding: utf-8 -*-
"""
Created on Tue Dec 27 21:01:00 2022
...
log_file = open(str(work_dir + 'logger_ads_notModABCAds ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
