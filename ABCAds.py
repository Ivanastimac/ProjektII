# -*- coding: utf-8 -*-
"""
Created on Mon Dec 12 16:28:16 2022
...
work_dir = 'C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCAds\\Logger\\'
...
log_file = open(str(work_dir + 'logger_ads_ABC ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
print('ABC Algorithm')
print()
...
for i, (train_index, test_index) in enumerate(skf.split(x, y)):
    ...
    plt.savefig('C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCAds\\Matrix\\default\\ABCAds' + str(i) +'.png')
    plt.show()
