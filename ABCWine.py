# -*- coding: utf-8 -*-
"""
Created on Sun Dec  12 13:24:46 2022
...
work_dir = 'C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCWine\\Logger\\'
...
log_file = open(str(work_dir + 'logger_wine_ABC ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
print('ABC Algorithm')
print()
...
for i, (train_index, test_index) in enumerate(skf.split(x, y)):
    ...
    plt.savefig('C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\ABCWine\\Matrix\\default\\ABCWine' + str(i) +'.png')
