# -*- coding: utf-8 -*-
"""
Created on Tue Dec 27 18:18:18 2022
...
work_dir = 'C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\FPAAds\\Logger\\'
...
log_file = open(str(work_dir + 'logger_ads_FPA ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
...
for i, (train_index, test_index) in enumerate(skf.split(x, y)):
    ...
    plt.savefig('C:\\Users\\ivana\\Documents\\Faks\\5. godina\\III semestar\\Projekt II\\Kod\\Ivana\\FPAAds\\Matrix\\default\\FPAAds' + str(i) +'.png')
    plt.show()
