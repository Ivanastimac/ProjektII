# -*- coding: utf-8 -*-
"""
Created on Tue Dec 27 20:55:04 2022
...
log_file = open(str(work_dir + 'logger_cancer_notModABCCancer ' + datetime.now().strftime('%Y-%m-%d %H-%M-%S') + '.txt'), 'w')
sys.stdout = log_file
